...
- **Homebrew dep**: `postgresql@16` → `postgresql@18` (Rev 69)
...
**Pre-publication checklist update:**
- [x] Root `flake.nix` packaging the binary for `nix run github:dimgord/sopds-go`
