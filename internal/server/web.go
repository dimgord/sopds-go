    ...
    <div class="audio-header" id="audioHeader">
        ...
        <div class="audio-info">
            ...
            <div class="audio-meta">
                ...
                <span class="text-muted" title="book id (for tts-link)"><i class="fas fa-hashtag"></i> {{.Book.ID}}</span>
            </div>
        </div>
